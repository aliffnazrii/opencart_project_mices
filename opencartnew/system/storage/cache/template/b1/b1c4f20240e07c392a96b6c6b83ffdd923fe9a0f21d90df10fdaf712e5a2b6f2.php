...
class __TwigTemplate_a838045b874e1724b8765aeefeb9145a9894c74a606eb57b3345dafe049dfc32 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
@media (max-width: 768px) {
  ...
  <p>1. This voucher is valid for a single transaction only and cannot be combined with other offers.</p>
  <p>2. The voucher must be used before the expiration date shown above.</p>
  <p>3. The voucher value cannot be exchanged for cash or used to purchase gift cards.</p>
  <p>4. The voucher is only valid for online purchases through our official website.</p>
  <p>5. We reserve the right to modify or cancel this voucher at any time without prior notice.</p>
  <p>6. The voucher cannot be used for purchases of certain restricted items.</p>
  <p>7. In case of any disputes, the decision of our management will be final.</p>
  <p>8. The voucher cannot be resold or transferred to another party.</p>
  <p>9. Please present this voucher code at checkout to redeem your discount.</p>
  <p>10. Any attempt at fraud or misuse of this voucher will result in cancellation of the offer.</p>
</div>
            </div>
            </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            echo "              <div class=\"voucher-card\">
                <div class=\"voucher-left\">
                  <div class=\"discount-amount\">
                    ";
            // line 507
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 507);
            echo "
                  </div>
                  <div class=\"discount-type\">
                    ";
            // line 510
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 510);
            echo "
                  </div>
                </div>
                <div class=\"voucher-right\">
                  <div>
                    <div class=\"voucher-title\">
                      ";
            // line 516
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 516);
            echo "
                    </div>
            ...
            echo "
                      ...
                      ";
            // line 521
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 521);
            echo "
                    </div>
                    <div class=\"voucher-terms\">
                      ";
            // line 524
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 524);
            echo "
                    </div>
                  </div>
                  <button onclick=\"openVoucherModal(this)\" data-voucher-name=\"";
            // line 527
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 527);
            echo "\" data-voucher-code=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 527);
            echo "\" data-voucher-amount=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 527);
            echo "\" data-voucher-validity=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 527);
            echo "\" data-voucher-description=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 527);
            echo "\" class=\"claim-button";
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 527) == 0)) {
                echo " claimed";
            }
            echo "\">
                    ";
            // line 528
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 528) == 1)) {
                // line 529
                echo "                      ";
  ...
  ";
    ...
    {
        return array (  687 => 542,  681 => 539,  676 => 537,  672 => 535,  663 => 531,  657 => 529,  655 => 528,  639 => 527,  633 => 524,  627 => 521,  622 => 519,  616 => 516,  607 => 510,  601 => 507,  596 => 504,  592 => 503,  328 => 242,  306 => 223,  282 => 202,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
