...
class __TwigTemplate_3fe73151b1c7950d3440ebd85b3a0b27573c2f512549471c4c542ed91824b13c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"content\">
    ...
    <div class=\"container-fluid\">
        ...
        echo "                                        </div>
                        ...
                        <div class=\"form-group required\">
                            <label class=\"col-sm-2 control-label\">
                                ";
        // line 152
        echo ($context["entry_voucher_sync_status"] ?? null);
        echo "
                            </label>
                            <div class=\"col-sm-10\">
                                <div class=\"well well-sm\" style=\"height: 150px; overflow: auto;\">
        ...
        // line 156
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["voucher_statuses"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["voucher_status"]) {
            // line 157
            echo "                                        ";
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["voucher_status"], "voucher_status_id", [], "any", false, false, false, 157), ($context["module_acilit_voucher_sync_status"] ?? null))) {
                // line 158
                echo "                                            <div class=\"checkbox\">
                                                <label>
                                                    <input type=\"checkbox\" name=\"module_acilit_voucher_sync_status[]\" value=\"";
                // line 160
                echo twig_get_attribute($this->env, $this->source, $context["voucher_status"], "voucher_status_id", [], "any", false, false, false, 160);
                echo "\" checked=\"checked\">
                                                        ";
                // line 161
                echo twig_get_attribute($this->env, $this->source, $context["voucher_status"], "name", [], "any", false, false, false, 161);
                echo "
                                                    </label>
                                                </div>
                                            ";
                ...
                echo "                                                <div class=\"checkbox\">
                                                    <label>
                                                        <input type=\"checkbox\" name=\"module_acilit_voucher_sync_status[]\" value=\"";
                // line 167
                echo twig_get_attribute($this->env, $this->source, ($context["voucherr_status"] ?? null), "voucher_status_id", [], "any", false, false, false, 167);
                echo "\">
                                                            ";
                // line 168
                echo twig_get_attribute($this->env, $this->source, $context["voucher_status"], "name", [], "any", false, false, false, 168);
                echo "
                                                        </label>
                                                    </div>
                                                ";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['voucher_status'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 173
        echo "                                        </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["order_status"]) {
            // line 185
            echo "                                                        ";
            if ((twig_get_attribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 185) == ($context["module_acilit_order_complete_status"] ?? null))) {
                // line 186
                echo "                                                            <option value=\"";
                ...
                echo "\">
                                                                ";
                // line 191
                echo twig_get_attribute($this->env, $this->source, $context["order_status"], "name", [], "any", false, false, false, 191);
                echo "
                                                            </option>
                                                        ";
            }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["order_status"]) {
            // line 205
            echo "                                                        ";
            if ((twig_get_attribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 205) == ($context["module_acilit_order_canceled_status"] ?? null))) {
                // line 206
                echo "                                                            <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 206);
                echo "\" selected=\"selected\">
                                                                ";
                // line 207
                ...
                echo "\">
                                                                ";
                // line 211
                echo twig_get_attribute($this->env, $this->source, $context["order_status"], "name", [], "any", false, false, false, 211);
                echo "
                                                            </option>
                                                        ";
            }
  ...
  //--></script>
    ...
    {
        return array (  696 => 344,  683 => 334,  672 => 325,  666 => 322,  659 => 318,  655 => 316,  649 => 313,  642 => 309,  638 => 307,  636 => 306,  630 => 303,  624 => 299,  618 => 296,  611 => 292,  607 => 290,  601 => 287,  594 => 283,  590 => 281,  588 => 280,  582 => 277,  576 => 273,  570 => 270,  563 => 266,  559 => 264,  553 => 261,  546 => 257,  542 => 255,  540 => 254,  534 => 251,  528 => 247,  522 => 244,  515 => 240,  511 => 238,  505 => 235,  498 => 231,  494 => 229,  492 => 228,  486 => 225,  479 => 221,  471 => 215,  465 => 214,  459 => 211,  454 => 210,  448 => 207,  443 => 206,  440 => 205,  436 => 204,  429 => 200,  422 => 195,  416 => 194,  410 => 191,  405 => 190,  399 => 187,  394 => 186,  391 => 185,  387 => 184,  380 => 180,  371 => 173,  365 => 172,  358 => 168,  354 => 167,  350 => 165,  343 => 161,  339 => 160,  335 => 158,  332 => 157,  328 => 156,  321 => 152,  312 => 145,  306 => 144,  299 => 140,  295 => 139,  291 => 137,  284 => 133,  280 => 132,  276 => 130,  273 => 129,  269 => 128,  262 => 124,  246 => 113,  239 => 109,  232 => 105,  225 => 100,  219 => 97,  212 => 93,  208 => 91,  202 => 88,  195 => 84,  191 => 82,  189 => 81,  183 => 78,  175 => 73,  169 => 70,  161 => 65,  155 => 62,  148 => 58,  142 => 55,  135 => 51,  129 => 47,  120 => 41,  116 => 39,  113 => 38,  104 => 32,  100 => 30,  98 => 29,  92 => 25,  82 => 21,  78 => 20,  75 => 19,  71 => 18,  65 => 15,  57 => 10,  49 => 7,  41 => 2,  37 => 1,);
    }
