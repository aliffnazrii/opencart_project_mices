...
class __TwigTemplate_d5240c3b2e1c60a20bf4c532721dc2065f8363dbd72d4bc13bbd78b1915839ae extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<span class=\"text-center\" style=\"font-weight:700; font-size:20px; margin:100px; color:#5A0F14;\">";
        // line 94
        echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "firstname", [], "any", false, false, false, 94));
        echo " ";
        echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "lastname", [], "any", false, false, false, 94));
        echo "</span>
