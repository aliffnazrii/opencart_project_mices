...
class __TwigTemplate_c3481a9917d9041c9997aa7e25e094b4c1a8bc392ab2da135e14e97eea13f5ff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<span style=\"color:#000; font-weight:900; font-size:18px\">";
            // line 80
            echo twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "telephone", [], "any", false, false, false, 80);
            echo "</span>
\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t\t\t<span class=\"text-center\" style=\"font-weight:700; font-size:20px; color:#5A0F14;\">";
            // line 85
            echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "firstname", [], "any", false, false, false, 85));
            echo " ";
            echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "lastname", [], "any", false, false, false, 85));
            echo "</span>
\t\t\t\t<div id=\"reward-points-value\" style=\"color:#6A3B25; font-size:40px; font-weight:600\">";
            // line 86
            echo twig_number_format_filter($this->env, twig_round(twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "points", [], "any", false, false, false, 86)), 0, ".", ",");
            echo "</div>
...
\t\t\t\t";
                // line 94
                if (twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "renewal_min_purchase_left", [], "any", false, false, false, 94)) {
                    // line 95
                    echo "\t\t\t\t<tr>
...
\t\t\t\tShop up to <span style=\"color:#79432A; font-weight:600;\">";
                    // line 98
                    echo twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "renewal_min_purchase_left", [], "any", false, false, false, 98);
                    echo "</span> more by <span style=\"color:#79432A; font-weight:600;\">";
                    echo twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "tier_renewal_date", [], "any", false, false, false, 98), "d/m/Y");
                    echo "</span> to remain in <span style=\"color:#79432A; font-weight:600;\">";
                    echo twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "name", [], "any", false, false, false, 98);
                    echo "</span>.
\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t\t";
                ...
                // line 102
                echo "\t\t\t\t";
                if (twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "amount_left_to_upgrade", [], "any", false, false, false, 102)) {
                    // line 103
                    echo "\t\t\t\t<tr>
\t\t\t\t<td style=\"width: 1%; vertical-align: top; color: #79432A; font-weight: 600;\">*</td>
\t\t\t\t<td>
\t\t\t\tShop up to <span style=\"color:#79432A; font-weight:600;\">";
                    // line 106
                    echo twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "amount_left_to_upgrade", [], "any", false, false, false, 106);
                    echo "</span> more by <span style=\"color:#79432A; font-weight:600;\">";
                    echo twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "purchase_to_upgrade_by", [], "any", false, false, false, 106), "d/m/Y");
                    echo "</span> to tier up to <span style=\"color:#79432A; font-weight:600;\">";
                    echo twig_get_attribute($this->env, $this->source, ($context["tier_info"] ?? null), "next_tier_name", [], "any", false, false, false, 106);
                    echo "</span>.
\t\t\t\t</td>
\t\t\t\t</tr>
\t\t\t\t";
...
";
    ...
    {
        return array (  582 => 280,  576 => 277,  571 => 275,  563 => 270,  559 => 269,  552 => 265,  546 => 261,  539 => 257,  535 => 256,  528 => 252,  524 => 251,  521 => 250,  514 => 246,  510 => 245,  507 => 244,  505 => 243,  499 => 240,  487 => 231,  483 => 230,  475 => 225,  471 => 224,  464 => 220,  460 => 219,  452 => 214,  448 => 213,  441 => 209,  437 => 208,  434 => 207,  427 => 203,  423 => 202,  420 => 201,  418 => 200,  412 => 197,  408 => 196,  401 => 192,  397 => 191,  390 => 187,  386 => 185,  381 => 182,  371 => 178,  367 => 177,  364 => 176,  360 => 175,  354 => 172,  350 => 170,  348 => 169,  339 => 165,  333 => 164,  326 => 162,  320 => 159,  316 => 158,  309 => 154,  305 => 153,  298 => 149,  294 => 148,  287 => 144,  280 => 141,  274 => 138,  271 => 137,  269 => 136,  264 => 135,  261 => 134,  258 => 133,  255 => 132,  252 => 131,  249 => 130,  246 => 129,  244 => 128,  240 => 127,  237 => 126,  231 => 123,  227 => 121,  225 => 120,  220 => 118,  213 => 113,  208 => 110,  197 => 106,  192 => 103,  189 => 102,  178 => 98,  173 => 95,  171 => 94,  167 => 92,  165 => 91,  157 => 86,  151 => 85,  143 => 80,  139 => 79,  126 => 70,  124 => 69,  121 => 68,  111 => 64,  107 => 63,  104 => 62,  100 => 61,  37 => 1,);
    }
