...
class __TwigTemplate_b84e9668ecdf3c012aaf585e276f5459e05addc5f46fa7ff30b1096981a6e8bf extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    width: 100%;
      ...
      <div id=\"voucherModal\" class=\"voucher-modal\">
            ...
            <div class=\"coupon-main\">
              <div class=\"qr-code-section\">
                <div class=\"qr-code-container\">
                  <img src=\"https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=123\" alt=\"QR Code\">
                    <div class=\"qr-instructions\">
                      ";
        // line 214
        echo ($context["text_scan_qr"] ?? null);
        echo "
                    </div>
                  </div>
                </div>
        ...
        echo "
                    ...
                    <span class=\"detail-validity\"></span>
                  </div>
                </div>
              </div>
      ...
      <div class=\"voucher-container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            echo "            <div class=\"voucher-card\">
              <div class=\"voucher-left\">
                <div class=\"discount-amount\">
                  ";
            // line 516
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 516);
            echo "
                </div>
              ...
              <div class=\"voucher-right\">
                <div>
                  <div class=\"voucher-title\">
                    ";
            // line 525
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 525);
            echo "
                  </div>
                  <div class=\"voucher-validity\">
                    ";
            ...
            echo "
                    ...
                    ";
            // line 530
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 530);
            echo "
                  </div>
                  <div class=\"voucher-terms\">
                    ";
            // line 533
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 533);
            echo "
                  </div>
                </div>
                <button onclick=\"openVoucherModal(this)\" data-voucher-name=\"";
            // line 536
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 536);
            echo "\" data-voucher-code=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 536);
            echo "\" data-voucher-amount=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 536);
            echo "\" data-voucher-validity=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 536);
            echo "\" data-voucher-description=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 536);
            echo "\" class=\"claim-button";
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 536) == 0)) {
                echo " claimed";
            }
            echo "\">
                  ";
            // line 537
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 537) == 1)) {
                // line 538
                echo "                    ";
...
";
    ...
    {
        return array (  705 => 551,  699 => 548,  694 => 546,  690 => 544,  681 => 540,  675 => 538,  673 => 537,  657 => 536,  651 => 533,  645 => 530,  640 => 528,  634 => 525,  625 => 519,  619 => 516,  614 => 513,  610 => 512,  345 => 250,  335 => 243,  323 => 234,  312 => 226,  297 => 214,  282 => 202,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
