...
class __TwigTemplate_c1065055fa1d6f321e604543a531258b36a3e0dd2ed06bcd2a3847ca7901bf2b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\tMEMBERSHIP
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t<p class=\"text-center\" style=\"font-weight:600; font-size:30px; color:#5A0F14;\">
\t\t\t\t\t\t\t\t\t";
        // line 97
