...
class __TwigTemplate_3b9fcb91adc8955cc9f43c0b60ca7b1a50b69e8b41fba9cf7a00fd20c9fa9ac8 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\"> ";
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "</a>
                        <a id=\"btn-product-unlink\" class=\"btn btn-danger ";
        // line 105
        echo (((($context["acilit_item_id"] ?? null) == 0)) ? ("hide") : (""));
...
function unlinkProduct() {
    ...
    \$('#acilit-model-message').addClass('text-danger').text('Not Linked');
}
</script>
