...
class __TwigTemplate_4b2410db6a7baf5ae04fe07ff768609a33209cfc0866dde9bb455d43588f68ce extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                <div class=\"modal-dialog modal-dialog-centered\" style=\"max-width: none; width: calc(100% - 40px); height: calc(100vh - 40px); margin: 20px; position: fixed; top: 0; left: 0; right: 0; bottom: 0; border-radius: 25px;\">
                  <div class=\"modal-content\" style=\"height: 100%; border-radius: 10px; display: flex; flex-direction: column;\">
