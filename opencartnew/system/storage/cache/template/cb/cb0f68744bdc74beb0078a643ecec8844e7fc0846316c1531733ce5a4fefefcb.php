...
class __TwigTemplate_8fee3b8fd51e9a8e3a42c23cd71df5eccda216aecaeeee4bacf654051988fa0e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        ";
          ...
          <div class=\"button-group\">
            ...
            ";
                    // line 132
                    if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 132), "get", [0 => "catalogWishlistStatus"], "method", false, false, false, 132) || twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 132), "get", [0 => "catalogCompareStatus"], "method", false, false, false, 132))) {
                        // line 133
                        echo "            <div class=\"wish-group\">
              ";
                        // line 134
                        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 134), "get", [0 => "catalogWishlistStatus"], "method", false, false, false, 134)) {
                            // line 135
                            echo "              <a class=\"btn btn-wishlist\" ";
                            if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 135), "getIn", [0 => (($context["prefix"] ?? null) . "WishlistDisplay"), 1 => $context], "method", false, false, false, 135) == "icon") && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 135), "getIn", [0 => (($context["prefix"] ?? null) . "WishlistTooltipStatus"), 1 => $context], "method", false, false, false, 135))) {
                                echo " data-toggle=\"tooltip\" data-tooltip-class=\"";
                                echo ((($context["module_id"] ?? null)) ? ((("module-products-" . ($context["module_id"] ?? null)) . " module-products-grid")) : ("product-grid"));
                                echo " wishlist-tooltip\" data-placement=\"";
                                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 135), "getIn", [0 => (($context["prefix"] ?? null) . "WishlistTooltipPosition"), 1 => $context], "method", false, false, false, 135);
                                echo "\" title=\"";
              ...
              ";
                        // line 138
                        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 138), "get", [0 => "catalogCompareStatus"], "method", false, false, false, 138)) {
                            // line 139
                            echo "              <a class=\"btn btn-compare\" ";
                            if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 139), "getIn", [0 => (($context["prefix"] ?? null) . "CompareDisplay"), 1 => $context], "method", false, false, false, 139) == "icon") && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 139), "getIn", [0 => (($context["prefix"] ?? null) . "CompareTooltipStatus"), 1 => $context], "method", false, false, false, 139))) {
                                echo " data-toggle=\"tooltip\" data-tooltip-class=\"";
                                echo ((($context["module_id"] ?? null)) ? ((("module-products-" . ($context["module_id"] ?? null)) . " module-products-grid")) : ("product-grid"));
                                echo " compare-tooltip\" data-placement=\"";
                                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 139), "getIn", [0 => (($context["prefix"] ?? null) . "CompareTooltipPosition"), 1 => $context], "method", false, false, false, 139);
                                echo "\" title=\"";
...
\t\t\t\t";
        ...
        ";
            // line 150
            if (twig_get_attribute($this->env, $this->source, $context["product"], "extra_buttons", [], "any", false, false, false, 150)) {
                // line 151
            ...
            <div>
              ";
                // line 153
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["product"], "extra_buttons", [], "any", false, false, false, 153));
                $context['loop'] = [
                ...
                foreach ($context['_seq'] as $context["id"] => $context["extra_button"]) {
                  ...
                  ";
                    // line 155
                    if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 155), "getIn", [0 => ((($context["prefix"] ?? null) . "ExtraButtonDisplay") . twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 155)), 1 => $context], "method", false, false, false, 155) == "icon") && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 155), "getIn", [0 => (($context["prefix"] ?? null) . "ExtraButtonTooltipStatus"), 1 => $context], "method", false, false, false, 155))) {
                        echo " data-toggle=\"tooltip\" data-tooltip-class=\"";
                        echo ((($context["module_id"] ?? null)) ? ((("module-products-" . ($context["module_id"] ?? null)) . " module-products-grid")) : ("product-grid"));
                        echo " extra-tooltip\" data-placement=\"";
                        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 155), "getIn", [0 => (($context["prefix"] ?? null) . "ExtraButtonTooltipPosition"), 1 => $context], "method", false, false, false, 155);
                        echo "\" title=\"";
                    ...
                    // line 156
                    echo "                  ";
                    if ((twig_get_attribute($this->env, $this->source, $context["extra_button"], "action", [], "any", false, false, false, 156) == "quickbuy")) {
                        echo "onclick=\"cart.add('";
                    ...
                    // line 157
                    echo "                  ";
                    if (((twig_get_attribute($this->env, $this->source, $context["extra_button"], "action", [], "any", false, false, false, 157) == "link") && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["extra_button"], "link", [], "any", false, false, false, 157), "href", [], "any", false, false, false, 157))) {
                        echo "href=\"";
                        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["extra_button"], "link", [], "any", false, false, false, 157), "href", [], "any", false, false, false, 157);
                        echo "\" ";
                        echo twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "linkAttrs", [0 => twig_get_attribute($this->env, $this->source, $context["extra_button"], "link", [], "any", false, false, false, 157)], "method", false, false, false, 157);
                    ...
                    echo twig_get_attribute($this->env, $this->source, $context["extra_button"], "label", [], "any", false, false, false, 158);
                    echo "</span>\">
                  <span class=\"btn-text\">";
                    // line 159
                    echo twig_get_attribute($this->env, $this->source, $context["extra_button"], "label", [], "any", false, false, false, 159);
                    echo "</span>
                </a>
              ";
                    ++$context['loop']['index0'];
...
";
    ...
    {
        return array (  630 => 165,  625 => 162,  608 => 159,  603 => 158,  590 => 157,  583 => 156,  573 => 155,  568 => 154,  551 => 153,  547 => 151,  545 => 150,  542 => 149,  537 => 146,  532 => 143,  528 => 141,  510 => 139,  508 => 138,  505 => 137,  487 => 135,  485 => 134,  482 => 133,  480 => 132,  477 => 131,  457 => 128,  448 => 122,  442 => 121,  438 => 119,  436 => 118,  432 => 116,  430 => 115,  427 => 114,  425 => 113,  421 => 111,  416 => 108,  410 => 107,  406 => 105,  402 => 103,  399 => 102,  395 => 101,  387 => 99,  382 => 96,  376 => 95,  372 => 93,  368 => 91,  365 => 90,  361 => 89,  353 => 87,  351 => 86,  348 => 85,  344 => 83,  337 => 81,  335 => 80,  332 => 79,  326 => 77,  318 => 75,  316 => 74,  312 => 72,  310 => 71,  305 => 69,  302 => 68,  294 => 66,  292 => 65,  289 => 64,  285 => 62,  277 => 60,  274 => 59,  266 => 57,  264 => 56,  261 => 55,  259 => 54,  254 => 51,  248 => 49,  246 => 48,  243 => 47,  239 => 45,  226 => 43,  222 => 42,  219 => 41,  217 => 40,  211 => 36,  208 => 35,  186 => 33,  162 => 31,  159 => 30,  157 => 29,  154 => 28,  132 => 26,  108 => 24,  106 => 23,  97 => 21,  94 => 20,  76 => 17,  73 => 16,  71 => 15,  68 => 14,  60 => 12,  58 => 11,  50 => 9,  48 => 7,  47 => 6,  46 => 5,  45 => 4,  43 => 3,  39 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "journal3/template/journal3/product_card.twig", "C:\\Users\\pc\\Documents\\GitHub\\opencartnew\\system\\storage\\modification\\catalog\\view\\theme\\journal3\\template\\journal3\\product_card.twig");
    }
}
