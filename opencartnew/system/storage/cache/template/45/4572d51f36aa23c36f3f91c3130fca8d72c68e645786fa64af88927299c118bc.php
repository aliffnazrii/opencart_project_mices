...
class __TwigTemplate_94f4d999cc8e9559cc16440aed8b5b6c7081d1a93af5059ec00ec26fd8eea2b8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
@media (max-width: 768px) {
  ...
  const modalId = 'voucherModal-' + serial;
      ...
      <div class=\"voucher-container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            <div id=\"voucherModal-";
            // line 457
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 457);
            ...
            // line 463
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 463);
            echo "')\">
                    &times;
                  </span>
                </div>
                <div class=\"modal-body\">
                  <div class=\"qr-code-section\" style=\"text-align: center; padding: 20px;\">
                    <img src=\"";
            // line 469
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "path", [], "any", false, false, false, 469);
            ...
            // line 491
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 491);
              ...
              <div class=\"voucher-card\">
                <div class=\"voucher-left\">
                  <div class=\"discount-amount\">
                    ";
            // line 500
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 500);
            echo "
                  </div>
                  <div class=\"discount-type\">
                    ";
            // line 503
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 503);
            echo "
                  </div>
                </div>
                <div class=\"voucher-right\">
                  <div>
                    <div class=\"voucher-title\">
                      ";
            // line 509
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 509);
            echo "
                    </div>
            ...
            echo "
                      ...
                      ";
            // line 514
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 514);
            echo "
                    </div>
                    <div class=\"voucher-terms\">
                      ";
            // line 517
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 517);
            echo "
                    </div>
                  </div>
                  <button onclick=\"openVoucherModal(this, '";
            // line 520
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 520);
            echo "')\" data-voucher-name=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 520);
            echo "\" data-voucher-code=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 520);
            echo "\" data-voucher-amount=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 520);
            echo "\" data-voucher-validity=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 520);
            echo "\" data-voucher-description=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 520);
            echo "\" class=\"claim-button";
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 520) == 0)) {
                echo " claimed";
            }
            echo "\">
                    ";
            // line 521
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 521) == 1)) {
                // line 522
                echo "                      ";
  ...
  ";
    ...
    {
        return array (  694 => 535,  688 => 532,  683 => 530,  679 => 528,  670 => 524,  664 => 522,  662 => 521,  644 => 520,  638 => 517,  632 => 514,  627 => 512,  621 => 509,  612 => 503,  606 => 500,  595 => 492,  591 => 491,  579 => 482,  563 => 469,  554 => 463,  549 => 461,  542 => 457,  539 => 456,  535 => 455,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
