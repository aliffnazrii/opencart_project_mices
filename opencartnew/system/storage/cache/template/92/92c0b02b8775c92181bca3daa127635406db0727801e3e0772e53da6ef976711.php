...
class __TwigTemplate_03580034542f795db7f393565992ef0d84655582ac49cb0edf843fa3267faf70 extends \Twig\Template
{
    private $source;
    private $macros = [];
          ...
          <div class=\"row\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["coupon"]) {
                ...
                echo "\">
                        ";
                // line 50
                echo (((twig_get_attribute($this->env, $this->source, $context["coupon"], "status", [], "any", false, false, false, 50) == 1)) ? (($context["text_active"] ?? null)) : (""));
                echo "
                      </span>
                    </div>
                  </div>
