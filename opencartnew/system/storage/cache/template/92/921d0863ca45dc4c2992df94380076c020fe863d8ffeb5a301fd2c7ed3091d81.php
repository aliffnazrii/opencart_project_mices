...
class __TwigTemplate_a377bbd7ac433ffa67949771f10e3eb7d39a5c576d50da93d7a23d933372d6b5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
function closeVoucherModal(serial) {
    ...
    if (modal.style.display === 'block' && event.target === modal) {
      ...
      <div class=\"voucher-container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            <div id=\"voucherModal-";
            // line 459
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 459);
            echo "\" class=\"voucher-modal\">
            ...
            // line 465
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 465);
            echo "')\">
                    &times;
                  </span>
                </div>
                <div class=\"modal-body\">
                  <div class=\"qr-code-section\" style=\"text-align: center; padding: 20px;\">
                    <img src=\"";
            // line 471
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "path", [], "any", false, false, false, 471);
            echo "\" alt=\"QR Code\" style=\"width: 200px; height: 200px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);\"></div>
            ...
            // line 493
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 493);
            echo "')\" class=\"modal-close-btn animate-close\">
                      ";
            // line 494
              ...
              <div class=\"voucher-card\">
                <div class=\"voucher-left\">
                  <div class=\"discount-amount\">
                    ";
            // line 502
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 502);
            echo "
                  </div>
                  <div class=\"discount-type\">
                    ";
            // line 505
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 505);
            echo "
                  </div>
                </div>
                <div class=\"voucher-right\">
                  <div>
                    <div class=\"voucher-title\">
                      ";
            // line 511
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 511);
            echo "
                    </div>
            ...
            echo "
                      ...
                      ";
            // line 516
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 516);
            echo "
                    </div>
                    <div class=\"voucher-terms\">
                      ";
            // line 519
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 519);
            echo "
                    </div>
                  </div>
                  <button onclick=\"openVoucherModal(this, '";
            // line 522
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 522);
            echo "')\" data-voucher-name=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 522);
            echo "\" data-voucher-code=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 522);
            echo "\" data-voucher-amount=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 522);
            echo "\" data-voucher-validity=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 522);
            echo "\" data-voucher-description=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 522);
            echo "\" class=\"claim-button";
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 522) == 0)) {
                echo " claimed";
            }
            echo "\">
                    ";
            // line 523
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 523) == 1)) {
                // line 524
                echo "                      ";
      ...
      <div class=\"pagination\">
        ";
        // line 534
        if (twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "links", [], "any", false, false, false, 534)) {
            // line 535
            echo "          ";
            echo twig_get_attribute($this->env, $this->source, ($context["pagination"] ?? null), "links", [], "any", false, false, false, 535);
            echo "
        ";
        }
        // line 537
  ...
  ";
    ...
    {
        return array (  707 => 541,  701 => 538,  698 => 537,  692 => 535,  690 => 534,  685 => 532,  681 => 530,  672 => 526,  666 => 524,  664 => 523,  646 => 522,  640 => 519,  634 => 516,  629 => 514,  623 => 511,  614 => 505,  608 => 502,  597 => 494,  593 => 493,  581 => 484,  565 => 471,  556 => 465,  551 => 463,  544 => 459,  541 => 458,  537 => 457,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
