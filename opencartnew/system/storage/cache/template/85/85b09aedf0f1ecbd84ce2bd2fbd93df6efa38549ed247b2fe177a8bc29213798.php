...
class __TwigTemplate_c14231242bb1939748b01bafbd0a0c7bc47cfa6aa6d21b287ae49c6279f3e047 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    ";
      ...
      <div id=\"reward-points-banner-block\">
        ...
        echo " ";
        echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "lastname", [], "any", false, false, false, 82));
        echo "</span>
