...
class __TwigTemplate_60b7bdce792a5781e495cdd01e63e60a03f4bd3f67b1e4fc7b52f2d4e70d0a39 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            echo "
                  ...
                  <div class=\"voucher-validity\">
                    Valid until: ";
            // line 215
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 215);
            echo "
                  </div>
                  <div class=\"voucher-terms\">
                    ";
            // line 218
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 218);
            echo "
                  </div>
                </div>
                <button class=\"claim-button";
            // line 221
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 221) == 0)) {
                echo " claimed";
            }
            echo "\">
                  ";
            // line 222
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 222) == 1)) {
                echo "Claim Now";
            } else {
                echo "Claimed";
            }
...
";
    ...
    {
        return array (  357 => 234,  351 => 231,  346 => 229,  342 => 227,  333 => 223,  327 => 222,  321 => 221,  315 => 218,  309 => 215,  303 => 212,  294 => 206,  288 => 203,  283 => 200,  279 => 199,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
