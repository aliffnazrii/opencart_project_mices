...
class __TwigTemplate_a136016da6aaa628df05b0fbb3cb6157982d016dd567e11113cf8b3c0629c764 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<style>
\t\t\t\t.banner-style {
\t\t\t\tbackground: linear-gradient(90deg, #F9D342 0%, rgb(239, 219, 210) 50%, rgb(245, 231, 224) 70%, #F9D342 100%);
\t\t\t\tmargin-left: 10px;
\t\t\t\tmargin-right: 10px;
\t\t\t\tpadding: 10px;
\t\t\t\tpadding-bottom: 20px;
