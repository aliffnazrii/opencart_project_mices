...
class __TwigTemplate_b4350925bd1468cd36d387472d401903852a2243096d62294125a1c9996536b3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\tMEMBERSHIP
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t<p class=\"text-center\" style=\"font-weight:600; font-size:25px; color:#5A0F14;\">
\t\t\t\t\t\t\t\t\t(";
        // line 97
