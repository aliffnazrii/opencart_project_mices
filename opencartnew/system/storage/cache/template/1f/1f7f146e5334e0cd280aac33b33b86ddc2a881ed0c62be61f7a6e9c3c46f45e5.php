...
class __TwigTemplate_6ce6d14af1eff43c3c337c9f4a8b590246e70c51f162b500d7b882487a7cd4eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
function closeVoucherModal(serial) {
    ...
    if (modal.style.display === 'block' && event.target === modal) {
      ...
      <div class=\"voucher-container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            <div id=\"voucherModal-";
            // line 458
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 458);
            ...
            // line 464
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 464);
            echo "')\">
                    &times;
                  </span>
                </div>
                <div class=\"modal-body\">
                  <div class=\"qr-code-section\" style=\"text-align: center; padding: 20px;\">
                    <img src=\"";
            // line 470
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "path", [], "any", false, false, false, 470);
            ...
            // line 492
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 492);
              ...
              <div class=\"voucher-card\">
                <div class=\"voucher-left\">
                  <div class=\"discount-amount\">
                    ";
            // line 501
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 501);
            echo "
                  </div>
                  <div class=\"discount-type\">
                    ";
            // line 504
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 504);
            echo "
                  </div>
                </div>
                <div class=\"voucher-right\">
                  <div>
                    <div class=\"voucher-title\">
                      ";
            // line 510
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 510);
            echo "
                    </div>
            ...
            echo "
                      ...
                      ";
            // line 515
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 515);
            echo "
                    </div>
                    <div class=\"voucher-terms\">
                      ";
            // line 518
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 518);
            echo "
                    </div>
                  </div>
                  <button onclick=\"openVoucherModal(this, '";
            // line 521
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "serial", [], "any", false, false, false, 521);
            echo "')\" data-voucher-name=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 521);
            echo "\" data-voucher-code=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 521);
            echo "\" data-voucher-amount=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 521);
            ...
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 521);
            echo "\" class=\"claim-button";
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 521) == 0)) {
                echo " claimed";
            }
            echo "\">
                    ";
            // line 522
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 522) == 1)) {
                // line 523
                echo "                      ";
  ...
  ";
    ...
    {
        return array (  695 => 536,  689 => 533,  684 => 531,  680 => 529,  671 => 525,  665 => 523,  663 => 522,  645 => 521,  639 => 518,  633 => 515,  628 => 513,  622 => 510,  613 => 504,  607 => 501,  596 => 493,  592 => 492,  580 => 483,  564 => 470,  555 => 464,  550 => 462,  543 => 458,  540 => 457,  536 => 456,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
