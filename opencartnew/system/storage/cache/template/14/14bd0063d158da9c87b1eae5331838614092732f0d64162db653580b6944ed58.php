...
class __TwigTemplate_9f06036926ab2c5ce45300cc3d3e00d3433fc7e98dfdbed0f3d06fe793684f3b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<style>
\t\t\t\t.banner-style {
\t\t\t\tbackground: linear-gradient(90deg, #F9D342 0%, #F9D342 50%, #F9D342 70%, #F9D342 100%);
\t\t\t\tmargin-left: 10px;
\t\t\t\tmargin-right: 10px;
\t\t\t\tpadding: 10px;
\t\t\t\tpadding-bottom: 20px;
