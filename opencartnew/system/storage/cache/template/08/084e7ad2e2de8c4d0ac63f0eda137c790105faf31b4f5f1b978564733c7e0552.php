...
class __TwigTemplate_77ee2c78e45e3bde227279ed83f7363facb82e8210e8044d9d9f895f0e4ce127 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  \$('#product-voucher-mapping').append('<div id=\"product-voucher-mapping' + item['value'] + '\"><i class=\"fa fa-minus-circle\"></i> ' + item['label'] + '<input type=\"hidden\" name=\"product_voucher_mapping[]\" value=\"' + item['value'] + '\" /></div>');
\t  }
  });
