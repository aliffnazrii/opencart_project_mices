...
class __TwigTemplate_2fe6ff1a416c8f5b36faf1d6ce1864a660dcf58eab80f1d893636e744c02e567 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<style>
\t\t\t\t.banner-style {
\t\t\t\tbackground: linear-gradient(90deg, #F9D342 0%, rgb(239, 219, 210) 50%, rgb(245, 231, 224) 70%, #F9D342;
\t\t\t\tmargin-left: 10px;
\t\t\t\tmargin-right: 10px;
\t\t\t\tpadding: 10px;
\t\t\t\tpadding-bottom: 20px;
