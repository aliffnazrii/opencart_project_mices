...
class __TwigTemplate_91ab18910fcc444a51d4b6096f0be84e8ee663119dd118a377aa1925f09c5a60 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 1709);
            echo "][name]\"]').val(json.name);
\t\t\t\t\$('textarea[name=\"product_description[";
            // line 1710
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 1710);
            echo "][description]\"]').val(json.description);
\t\t\t\t";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['language'], $context['_parent'], $context['loop']);
