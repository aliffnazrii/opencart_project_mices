...
class __TwigTemplate_95f930be2f506f8d03902432bdbedfafea40a463a73227c179da1f5e6b92460c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<span class=\"text-center\" style=\"font-weight:700; font-size:20px; margin:100px; color:#5A0F14;\">";
        // line 89
        echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "firstname", [], "any", false, false, false, 89));
        echo " ";
        echo twig_upper_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["customer_info"] ?? null), "lastname", [], "any", false, false, false, 89));
        echo "</span>
