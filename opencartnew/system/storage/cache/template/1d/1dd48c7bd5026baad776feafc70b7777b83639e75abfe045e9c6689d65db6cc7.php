...
class __TwigTemplate_3398bef57d97400cf3f01a3e6863d479b6dce38530158a081880bcc0d21d9f34 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\tMEMBERSHIP
\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t<p class=\"text-center\" style=\"font-weight:500; font-size:30px; color:#5A0F14;\">
\t\t\t\t\t\t\t\t\t";
        // line 97
