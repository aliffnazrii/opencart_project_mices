...
class __TwigTemplate_2c472cac44770cb435f6450dd35e146397fbd571a16853b92c6280024d5fe1c5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
@media (max-width: 768px) {
      ...
      <div id=\"voucherModal\" class=\"voucher-modal\">
        ...
        echo "
          ...
          <div class=\"modal-body\">
            <div class=\"qr-code-section\" style=\"text-align: center; padding: 20px;\">
              <img src=\"https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=123\" alt=\"QR Code\" style=\"width: 200px; height: 200px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);\">
            </div>
            <div class=\"voucher-details-container\" style=\"display: flex; flex-direction: column; gap: 20px; padding: 20px;\">
              <div class=\"voucher-detail-card\" style=\"display: grid; grid-template-columns: 1fr 1fr; gap: 20px;\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher"]) {
            ...
            echo "              <div class=\"voucher-card\">
                <div class=\"voucher-left\">
                  <div class=\"discount-amount\">
                    ";
            // line 497
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 497);
            echo "
                  </div>
                  <div class=\"discount-type\">
                    ";
            // line 500
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 500);
            echo "
                  </div>
                </div>
            ...
            echo "
                      ...
                      ";
            // line 511
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 511);
            echo "
                    </div>
                    <div class=\"voucher-terms\">
                      ";
            // line 514
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "description", [], "any", false, false, false, 514);
            echo "
                    </div>
                  </div>
                  <button onclick=\"openVoucherModal(this)\" data-voucher-name=\"";
            // line 517
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "name", [], "any", false, false, false, 517);
            echo "\" data-voucher-code=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "code", [], "any", false, false, false, 517);
            echo "\" data-voucher-amount=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "amount", [], "any", false, false, false, 517);
            echo "\" data-voucher-validity=\"";
            echo twig_get_attribute($this->env, $this->source, $context["voucher"], "date_end", [], "any", false, false, false, 517);
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 517) == 0)) {
                echo " claimed";
            }
            echo "\">
                    ";
            // line 518
            if ((twig_get_attribute($this->env, $this->source, $context["voucher"], "status", [], "any", false, false, false, 518) == 1)) {
                // line 519
                echo "                      ";
  ...
  ";
    ...
    {
        return array (  677 => 532,  671 => 529,  666 => 527,  662 => 525,  653 => 521,  647 => 519,  645 => 518,  629 => 517,  623 => 514,  617 => 511,  612 => 509,  606 => 506,  597 => 500,  591 => 497,  586 => 494,  582 => 493,  318 => 232,  308 => 225,  282 => 202,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  89 => 22,  85 => 21,  79 => 18,  72 => 14,  68 => 12,  66 => 11,  63 => 10,  53 => 6,  49 => 5,  46 => 4,  42 => 3,  37 => 1,);
    }
