...
class ModelCustomerCustomer extends Model {
	...
	public function getCustomers($data = array()) {
		$sql = " SELECT c.*, CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.name AS customer_group, s.name AS store_name FROM oc_customer c LEFT JOIN oc_customer_group_description cgd ON c.customer_group_id = cgd.customer_group_id LEFT JOIN oc_store s ON c.store_id = s.store_id";
