...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_product->addProduct($this->request->post);
			 ...
			 $this->session->data['success'] = isset($this->request->get['is_voucher']) ?  $this->language->get('text_voucher_success') : $this->language->get('text_success'); 
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			 'text' =>isset( $this->request->get['is_voucher']) ? $this->language->get('voucher_heading_title') : $this->language->get('heading_title'),
			 'href' => $this->url->link(isset($this->request->get['is_voucher']) ? 'catalog/productVoucher' : 'catalog/product', 'user_token=' . $this->session->data['user_token'] . $url, true) 
		);

		$data['add'] = $this->url->link('catalog/product/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
 $data['is_voucher'] = isset($this->request->get['is_voucher']) ? $this->request->get['is_voucher'] : 0; 
