...
$data['sort_store'] = $this->url->link('customer/customer', 'user_token=' . $this->session->data['user_token'] . '&sort=store_name' . $url, true);
 ...
 $customer_info = $this->model_customer_customer->getCustomerByEmailStore($this->request->post['email'], $this->request->post['store_id']); 
